...
1. [Setup - The basics of getting started with node1](#setup)
    * [What node1 affects](#what-node1-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with node1](#beginning-with-node1)
